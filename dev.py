...
def get_app_data_directory():
    ...
    gui_dir = f'C:\\Users\\{username}\\AppData\\Roaming\\totk-aar\\totk-aar-dev'
...
def check_and_update_version(gui_dir):
    ...
    if os.path.exists(gui_path):
        ...
        url = 'https://raw.githubusercontent.com/fayaz12g/totk-aar/dev/GUI.py'
...
def update_app_data(gui_dir, aar_dir):
    ...
    url = 'https://github.com/fayaz12g/totk-aar/archive/dev.zip'
    response = requests.get(url)

    # Save the downloaded content as a zip file
    zip_file_path = os.path.join(aar_dir, 'totk-aar-dev.zip')
